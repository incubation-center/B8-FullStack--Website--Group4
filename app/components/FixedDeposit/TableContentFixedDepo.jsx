...
import datafixeddepo from "./datafixeddepo.json";
// import Bank from "../../components/FixedDeposit/BankFixedDepo";
import BankFixedDepo from "./BankFixedDepo";
import ResourceListfixedDepo from "./ResourceListfixedDepo";
import NumListFixedDepo from "../../components/FixedDeposit/NumListFixedDepo";
import SecondNumlist from "./SecondNumListFixedDepo";
      ...
      <div className="flex flex-col sm:flex sm:flex-col md:flex md:flex-row py-16 md:gap-[60px] ">
        ...
        <div>
          ...
          >
            ...
            <p className="bodyText mt-6">{datafixeddepo.belowTextOverview}</p>
            <div>
              <h1 className="titleText mt-12">Other resources</h1>
              <p className="bodyText mt-12">{datafixeddepo.otherResources.resource1}</p>
              <ResourceListfixedDepo />
              <p className="bodyText mt-6"> {datafixeddepo.otherResources.resource2}</p>
            </div>
          </div>
          ...
          >
            ...
            <p className="bodyText mt-6">
              {datafixeddepo.fixedDepoAcc.fixedDepoAccHead}
            </p>
            <ChooseFixedDepoList />
            <p className="bodyText mt-6">{datafixeddepo.fixedDepoAcc.fixedDepoAccEnd}</p>
          </div>
          <hr className="border-b-1 border-gray-100 my-12" />
          {/* what to know about fixed deposit accounts */}
          <div
          ...
          >
            <div>
              ...
              <div className="bodyText mt-4">
                <p>{datafixeddepo.aboutFixedDepoAcc.aboutFixedDepoAccHead}</p>
                <p className="mt-5">
                  {datafixeddepo.aboutFixedDepoAcc.aboutFixedDepoAccTitle}
                </p>
                <NumListFixedDepo />
                <p className="mt-5">
                  {datafixeddepo.aboutFixedDepoAcc.aboutFixedDepoAccSecond}
                </p>
                <SecondNumlist />
                <p className="mt-5">
                  {datafixeddepo.aboutFixedDepoAcc.aboutFixedDepoAccEnd}
                </p>
              </div>
              ...
              <div className="bodyText mt-6">
                <p className="">{datafixeddepo.getFixedDepoAcc.getFixedDepoAccHead}</p>
                <BulletFixedDepoList />
                <p className="mt-5">
                  {datafixeddepo.getFixedDepoAcc.getFixedDepoAccEnd}
                </p>
