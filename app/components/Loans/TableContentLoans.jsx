...
import KnowSaveAcc from "./KnowCompareLoans";
import SocialLink from "@/app/components/SocialLink";
import datacompareloans from "./datacompareloans.json";
import AboutLoanNumList from "../../components/Loans/AboutLoanNumList";
import NumListGetLoan from "../../components/Loans/NumListGetLoan";
      ...
      <div className="flex flex-col sm:flex sm:flex-col md:flex md:flex-row py-16 md:gap-[60px]">
        ...
        <div>
          ...
          >
            ...
            <p className="bodyText mt-6">{datacompareloans.textBelowOverview}</p>
            {/* software tools */}
            {/* <div className="mt-12">
          ...
          >
            ...
            <p className="bodyText mt-6">{datacompareloans.loan.loanIntro}</p>
            <ChooseSavAccListLoans />
            <p className="bodyText mt-5">{datacompareloans.loan.loanEnd}</p>
          </div>
          <hr className="border-b-1 border-gray-100 my-12" />
          ...
          >
            <div>
              ...
              <div className="bodyText mt-4">
                <p>{datacompareloans.aboutLoan.aboutLoanHead}</p>
                <p className="mt-5">{datacompareloans.aboutLoan.aboutLoanTitle}</p>
                <AboutLoanNumList />
                <p className="mt-5">{datacompareloans.aboutLoan.aboutLoanEnd}</p>
              </div>
              ...
              <div className="bodyText mt-6">
                <p className="">{datacompareloans.getLoan.getLoanHead}</p>
                <NumListGetLoan />
                <p className="mt-5">{datacompareloans.getLoan.secondHead}</p>
                <BulletListGetLoan />
                <p className="mt-5">{datacompareloans.getLoan.endGetLoan}</p>
              </div>
            </div>
          </div>
        </div>
