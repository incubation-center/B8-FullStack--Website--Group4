...
export async function getAlldepositsdefualt() {
  try {
    const data = await axios.get(
      `http://34.126.97.182:8080/fixeddeposits/bank-term?currency=KHR&rateAt=Maturity&term=6&term=12&term=24&term=48      `
    );
    if (data.status === 200) {
...
export async function fetchAllBanks() {
  try {
    const data = await axios.get(
      `http://34.126.97.182:8080/fixeddeposits/bank-term?currency=KHR&rateAt=Maturity`
    );
    if (data.status === 200) {
      const alldata = data.data;
      return alldata;
...
export async function getAllfixeddepositlist(queryParams) {
  try {
    const response = await axios.get(
      "http://34.126.97.182:8080/fixeddeposits/bank-term",
      {
        params: queryParams,
...
export async function getAllfixeddeposithistory(queryParams) {
  try {
    const response = await axios.get(
      "http://34.126.97.182:8080/fixeddeposits/hist",
      {
        params: queryParams,
        paramsSerializer: (params) => {
          return qs.stringify(params);
...
export async function getAlldepositsDefualtLineChart() {
  try {
    const data = await axios.get(
      `http://34.126.97.182:8080/fixeddeposits/hist?currency=KHR&rateAt=Maturity&term=6&term=12&term=24&term=48`
    );
    if (data.status === 200) {
      const alldata = data.data;
      return alldata;
